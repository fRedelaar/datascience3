...
train_spellchecked = pd.read_csv('spelling_correctors/BERT results/BERT-neuspell-train.csv', encoding="ISO-8859-1")
test_spellchecked = pd.read_csv('spelling_correctors/BERT results/BERT-neuspell-test.csv', encoding="ISO-8859-1")
